...
function getAircraftIconSvg(ac, color) {
    ...
    const tarShapes = {
        ...
        'helo_2b': { viewBox: '0 0 50 50', sw: 1.5, path: 'M25 6 C20 6 18 11 18 19 L18 28 C18 31 20 33 22 34 L22 44 L28 44 L28 34 C30 33 32 31 32 28 L32 19 C32 11 30 6 25 6 Z M18 42 L32 42', rotors: '<path d="M14 18 L14 36 M36 18 L36 36 M14 24 L18 24 M36 24 L32 24 M14 32 L18 32 M36 32 L32 32" stroke="#000" stroke-width="1.8"/><path d="M21 9 C23 7 27 7 29 9 L29 14 C27 15 23 15 21 14 Z" fill="#111827" stroke="#000"/><line x1="28" y1="44" x2="33" y2="44" stroke="#000" stroke-width="2"/><line x1="2" y1="19" x2="48" y2="19" stroke="#000" stroke-width="2.5"/><circle cx="25" cy="19" r="3" fill="#ffffff" stroke="#000"/>' },
        'helo_b206': { viewBox: '0 0 50 50', sw: 1.5, path: 'M25 5 C19 5 17 10 17 20 L17 29 C17 32 19.5 34 22.5 34.5 L22.5 45 L27.5 45 L27.5 34.5 C30.5 34 33 32 33 29 L33 20 C33 10 31 5 25 5 Z', rotors: '<path d="M13 16 L13 36 M37 16 L37 36 M13 22 L17 22 M37 22 L33 22 M13 31 L17 31 M37 31 L33 31" stroke="#000" stroke-width="2"/><circle cx="22" cy="22" r="1.8" fill="#111827"/><circle cx="28" cy="22" r="1.8" fill="#111827"/><path d="M27.5 42 L33 42 L31 46 L27.5 46 Z"/><line x1="27.5" y1="44" x2="34" y2="44" stroke="#000" stroke-width="2"/><line x1="2" y1="18" x2="48" y2="18" stroke="#000" stroke-width="2.8"/><circle cx="25" cy="18" r="3.2" fill="#ffffff" stroke="#000"/>' },
        'helo_b407': { viewBox: '0 0 50 50', sw: 1.5, path: 'M25 5 C19 5 16.5 10 16.5 20 L16.5 29 C16.5 32 19 34.5 22 35 L22 45 L28 45 L28 35 C31 34.5 33.5 32 33.5 29 L33.5 20 C33.5 10 31 5 25 5 Z', rotors: '<path d="M12 16 L12 36 M38 16 L38 36 M12 22 L16 22 M38 22 L34 22 M12 31 L16 31 M38 31 L34 31" stroke="#000" stroke-width="2"/><path d="M15 41 L22 41 M28 41 L35 41" stroke="#000" stroke-width="2.5"/><line x1="28" y1="44" x2="34" y2="44" stroke="#000" stroke-width="2"/><line x1="4" y1="4" x2="46" y2="32" stroke="#000" stroke-width="2.2"/><line x1="46" y1="4" x2="4" y2="32" stroke="#000" stroke-width="2.2"/><circle cx="25" cy="18" r="3.5" fill="#ffffff" stroke="#000"/>' },
        'helo_h125': { viewBox: '0 0 50 50', sw: 1.5, path: 'M25 5 C19.5 5 17 10 17 20 L17 29 C17 32 19.5 34 22.5 34.5 L22.5 45 L27.5 45 L27.5 34.5 C30.5 34 33 32 33 29 L33 20 C33 10 30.5 5 25 5 Z', rotors: '<path d="M13 17 L13 36 M37 17 L37 36 M13 24 L17 24 M37 24 L33 24" stroke="#000" stroke-width="2"/><path d="M27.5 40 L34 40 L32 45 L27.5 45 Z"/><line x1="25" y1="18" x2="25" y2="1" stroke="#000" stroke-width="2.6"/><line x1="25" y1="18" x2="8" y2="30" stroke="#000" stroke-width="2.6"/><line x1="25" y1="18" x2="42" y2="30" stroke="#000" stroke-width="2.6"/><circle cx="25" cy="18" r="3.5" fill="#ffffff" stroke="#000"/>' },
        'helo_h135': { viewBox: '0 0 50 50', sw: 1.5, path: 'M25 5 C19.5 5 16.5 9.5 16.5 18 L16.5 28 C16.5 31.5 19.5 33.5 22 34 L22 41 L28 41 L28 34 C30.5 33.5 33.5 31.5 33.5 28 L33.5 18 C33.5 9.5 30.5 5 25 5 Z', rotors: '<circle cx="25" cy="44" r="4.2" fill="none" stroke="#000" stroke-width="2.5"/><circle cx="25" cy="44" r="1.5" fill="#ffffff"/><line x1="4" y1="4" x2="46" y2="32" stroke="#000" stroke-width="2.2"/><line x1="46" y1="4" x2="4" y2="32" stroke="#000" stroke-width="2.2"/><circle cx="25" cy="18" r="3.5" fill="#ffffff" stroke="#000"/>' },
        'helo_aw139': { viewBox: '0 0 50 50', sw: 1.5, path: 'M25 4 C19 4 16 8.5 16 18 L16 30 C16 33 19 35 22 35.5 L22 45 L28 45 L28 35.5 C31 35 34 33 34 30 L34 18 C34 8.5 31 4 25 4 Z', rotors: '<rect x="12" y="22" width="3" height="7" rx="1.5"/><rect x="35" y="22" width="3" height="7" rx="1.5"/><line x1="25" y1="18" x2="25" y2="1" stroke="#000" stroke-width="2"/><line x1="25" y1="18" x2="45" y2="12" stroke="#000" stroke-width="2"/><line x1="25" y1="18" x2="38" y2="35" stroke="#000" stroke-width="2"/><line x1="25" y1="18" x2="12" y2="35" stroke="#000" stroke-width="2"/><line x1="25" y1="18" x2="5" y2="12" stroke="#000" stroke-width="2"/><circle cx="25" cy="18" r="3.8" fill="#ffffff" stroke="#000"/>' },
        'helo_s76': { viewBox: '0 0 50 50', sw: 1.5, path: 'M25 3 C19.5 3 15.5 7 15.5 17 L15.5 31 C15.5 34 18.5 36 21.5 36.5 L21.5 46 L28.5 46 L28.5 36.5 C31.5 36 34.5 34 34.5 31 L34.5 17 C34.5 7 30.5 3 25 3 Z', rotors: '<path d="M12 43 L38 43" stroke="#000" stroke-width="3"/><line x1="28.5" y1="46" x2="35" y2="46" stroke="#000" stroke-width="2.2"/><line x1="3" y1="3" x2="47" y2="31" stroke="#000" stroke-width="2.4"/><line x1="47" y1="3" x2="3" y2="31" stroke="#000" stroke-width="2.4"/><circle cx="25" cy="17" r="3.8" fill="#ffffff" stroke="#000"/>' },
        'helo_4b': { viewBox: '0 0 50 50', sw: 1.5, path: 'M25 5 C19.5 5 16 9 16 19 L16 30 C16 33.5 19 35.5 22 36 L22 45 L28 45 L28 36 C31 35.5 34 33.5 34 30 L34 19 C34 9 30.5 5 25 5 Z', rotors: '<path d="M12 20 L16 20 L16 26 L12 26 Z M34 20 L38 20 L38 26 L34 26 Z"/><line x1="28" y1="45" x2="35" y2="42" stroke="#000" stroke-width="2.5"/><line x1="3" y1="3" x2="47" y2="31" stroke="#000" stroke-width="2.4"/><line x1="47" y1="3" x2="3" y2="31" stroke="#000" stroke-width="2.4"/><circle cx="25" cy="17" r="3.8" fill="#ffffff" stroke="#000"/>' },
        'helo_ah64': { viewBox: '0 0 50 50', sw: 1.5, path: 'M25 5 C22.5 5 20 9 20 19 L20 30 C20 33 22 34.5 23 35 L23 45 L27 45 L27 35 C28 34.5 30 33 30 30 L30 19 C30 9 27.5 5 25 5 Z', rotors: '<rect x="7" y="19" width="36" height="3"/><rect x="8" y="17" width="3" height="7"/><rect x="14" y="17" width="3" height="7"/><rect x="33" y="17" width="3" height="7"/><rect x="39" y="17" width="3" height="7"/><rect x="24.2" y="1" width="1.6" height="5"/><line x1="3" y1="3" x2="47" y2="31" stroke="#000" stroke-width="2.4"/><line x1="47" y1="3" x2="3" y2="31" stroke="#000" stroke-width="2.4"/><circle cx="25" cy="17" r="3.5" fill="#ffffff" stroke="#000"/>' },
        'helo_tandem': { viewBox: '0 0 50 60', sw: 1.5, path: 'M25 10 C20 10 18 14 18 24 L18 46 C18 52 20 54 25 54 C30 54 32 52 32 46 L32 24 C32 14 30 10 25 10 Z', rotors: '<path d="M15 18 L18 18 L18 42 L15 42 Z M32 18 L35 18 L35 42 L32 42 Z"/><line x1="25" y1="14" x2="5" y2="5" stroke="#000" stroke-width="2.6"/><line x1="25" y1="14" x2="45" y2="5" stroke="#000" stroke-width="2.6"/><line x1="25" y1="14" x2="25" y2="32" stroke="#000" stroke-width="2.6"/><circle cx="25" cy="14" r="3.2" fill="#ffffff" stroke="#000"/><line x1="25" y1="50" x2="5" y2="57" stroke="#000" stroke-width="2.6"/><line x1="25" y1="50" x2="45" y2="57" stroke="#000" stroke-width="2.6"/><line x1="25" y1="50" x2="25" y2="32" stroke="#000" stroke-width="2.6"/><circle cx="25" cy="50" r="3.2" fill="#ffffff" stroke="#000"/>' }
    };
    ...
    const shp = tarShapes[shapeKey] || tarShapes['cessna'];
