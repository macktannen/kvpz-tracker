...
function getAircraftIconSvg(ac, color) {
    ...
    else if (matchType(['C172','C182','C150','PA28','SR22','CESSNA','PIPER','CIRRUS'])) shapeKey = 'cessna';
    else if (matchType(['BLIMP','BALLOON','AIRSHIP'])) shapeKey = 'blimp';
    else shapeKey = 'generic_triangle';
...
window.renderIconOverrideCard = function(ac) {
    ...
    const shapesList = [
        { key: 'generic_triangle', label: '🔺 Generic Radar Target Triangle' },
